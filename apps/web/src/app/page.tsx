        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              Everything you need for precise tempo management.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-12 text-foreground/80 leading-relaxed">
            <div>
              ...
              <p>
                Tempo isn't just a number on a grid—it's the emotional pulse of the music. A
                shift of just 2 BPM can change a track from a relaxed groove into a driving,
                urgent anthem. Understanding tempo is understanding emotion.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-bold mb-3 text-foreground">The Grid</h3>
              <p>
                In modern production, everything locks to the grid. Whether you're aligning
                LFOs, calculating reverb pre-delays, or syncing arpeggiators, precise
                mathematical relationships to the BPM are what make a mix sound tight and
                professional.
              </p>
            </div>
            <div>
              ...
              <p>
                Translating the rhythm in your head to the software in your computer requires
                precision. A great tap tempo tool bridges the gap between human feel and
                digital exactness, letting you capture inspiration instantly.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex justify-between items-end mb-12">
            <div>
              ...
              <p className="text-muted-foreground text-lg">
                Guides, theory, and production tips.
              </p>
            </div>
            <Link href="/blog">
                  ...
                  <Card className="h-full hover:border-primary/50 transition-colors cursor-pointer group bg-muted/30 hover:bg-card">
                    <CardHeader>
                      <div className="flex gap-4 text-xs text-muted-foreground mb-3 font-mono">
                        <span>{article.createdAt ? new Date(article.createdAt).toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" }) : ""}</span>
                      </div>
