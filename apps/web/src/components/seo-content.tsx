    ...
    <div className="mt-16 space-y-12 text-foreground">
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3 text-sm text-muted-foreground leading-relaxed">
          <p>
            ...
            Maybe you want to sample it, mix it into a DJ set, build a running playlist, or practice it with a metronome.
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <StepCard num={5} title="Apply the BPM immediately" desc="Enter it into your metronome, set your DAW to that BPM, align the beat grid in DJ software, determine delay time for a guitar pedal, or check which genre your song matches." />
        </div>
      </section>
