      ...
      <section className="space-y-3">
        ...
        <div className="divide-y rounded-xl border">
          <FaqItem
            ...
            a={<>A <Link href="/tap-tempo" className="text-primary hover:underline font-bold">tap tempo tool</Link> finds BPM by tapping a button in real time, fastest for a song playing right now. A BPM calculator works from a manually counted number of beats over a known time, making it more accurate for live performances or when you don't have a device to tap along with.</>} />
          <FaqItem
